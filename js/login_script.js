import { success_modal, validateUsername, validateEmail, validatePassword } from '../js/functions.js';
        ...
        if (Object.keys(errors).length == 0) {
            ...
            fetch('http://localhost/travel_booking_system/travel_booking_system/html/ajax.php', {
                ...
                if (data.login == true) {
                    ...
                    setTimeout(() => {
                        window.location.href = "http://localhost/travel_booking_system/travel_booking_system/html/index.php";
                    }, 3000)
                } else {
